        ...
        def loadIndexCallback(err, root):
            ...
            if options['groups']:
                ...
                for comp in rootCompounds:
                    ...
                    helper.writeCompound(comp, [r.render(comp)], doxyparser.references, options)
                    for e in compounds:
                        e.filterChildren(options['filters'])
                        helper.writeCompound(e, [r.render(e)], doxyparser.references, options)
            # Output single file
            else:
                root.filter_children(options['filters'], 0)
            ...
            if options['pages']:
                ...
                for page in pages:
                    ...
                    helper.writeCompound(page, template.render(compounds), self.doxyparser.references, options)
